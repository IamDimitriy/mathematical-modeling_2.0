...
table_size_x, table_size_y = 120, 100
# экран и вывод
screen = pygame.display.set_mode((BOX_WIGHT, BOX_HEIGHT))
screen_rect = screen.get_rect()
clock = pygame.time.Clock()
dir = pathlib.Path(__file__).parent.resolve()  # директория проекта
icon = pygame.image.load(
    dir/"images"/"petri_dish.jpg")
bg_image = pygame.image.load(
    dir/"images"/"background.jpg").convert()
"""Объекты"""
# группы объектов
...
"""Настройки животных"""
# Настройки бактерий
img_normal = dir/"images"/"sprites"/"bacs"/"normal_bac.png"
crispr_def = []
